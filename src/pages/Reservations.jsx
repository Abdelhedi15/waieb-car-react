...
const getCarPhoto = (vehicle) => IMMAT_PHOTOS[vehicle?.immatriculation] || (vehicle?.photo ? `https://web-production-e6e97.up.railway.app${vehicle.photo}` : null) || CAR_PHOTOS[(vehicle?.marque || '').toLowerCase()] || CAR_PHOTOS.default;
